...
const LandingPage = ({
  ...
  const t = {
    ...
    voicesTitle: trans('voicesTitle', language),
    voicesSub: trans('voicesSub', language),
    story: trans('story', language),
    pro: trans('pro', language),
    event: trans('event', language),
    storyTitle: trans('storyTitle', language),
    proTitle: trans('proTitle', language),
    eventTitle: trans('eventTitle', language),
              ...
              {user ? (
                <>
                  <div className="relative">
                    ...
                    {showNotifications && (
                      <div className="absolute right-0 mt-2 w-80 max-w-[calc(100vw-24px)] bg-white dark:bg-surface-dark rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden animate-scale-in text-left z-[100] ring-1 ring-black/5">
                            ...
                            notifications.map((n) => (
                              ...
                              >
                                <div className="relative flex-none group/avatar cursor-pointer" onClick={(e) => {
                                  e.stopPropagation();
                                  setSelectedImage(n.actor?.avatar_url || `https://i.pravatar.cc/150?u=${n.actor_id}`);
                                }}>
                                  <img
            ...
            {user && (
              <>
                ...
                <div className="relative">
                  ...
                  {showNotifications && (
                    <div className="absolute right-0 top-full mt-2 w-80 max-w-[calc(100vw-24px)] bg-white dark:bg-surface-dark rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden animate-scale-in text-left z-[100] ring-1 ring-black/5">
                      <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50">
                        <h4 className="font-black text-[11px] uppercase tracking-[0.2em] text-slate-400">
                          {t.notifs}
                        </h4>
